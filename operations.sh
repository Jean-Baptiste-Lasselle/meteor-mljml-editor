...
export MARGUERITE_METEOR_PORT=$(cat ./.env|grep MARGUERITE_METEOR_PORT | awk -F = '{print $2}')
...
export ID_IMAGE_MARGUERITE_IDE_METEOR=$IMAGES_MARGUERITE_COMPANY_NAME/$IMAGE_MARGUERITE_IDE_METEOR_PRODUCT_NAME:$VERSION_IMAGE_MARGUERITE_IDE_METEOR
...
echo "  "
# read DEBUGJBLRMI
export LISTE_BUILD_ARGS="--build-arg WORKSPACE_IDE=$WORKSPACE_IDE"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg NOM_PROJET_MARGUERITE_METEOR=$NOM_PROJET_MARGUERITE_METEOR"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_METEOR_PORT=$MARGUERITE_METEOR_PORT"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_METEOR_VERSION=$MARGUERITE_METEOR_VERSION"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_METEOR_NODE_OPTIONS=$MARGUERITE_METEOR_NODE_OPTIONS"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_NVM_VERSION=$MARGUERITE_NVM_VERSION"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_NODEJS_VERSION=$MARGUERITE_NODEJS_VERSION"
export LISTE_BUILD_ARGS="$LISTE_BUILD_ARGS --build-arg MARGUERITE_NPM_VERSION=$MARGUERITE_NPM_VERSION"


docker build -t $ID_IMAGE_MARGUERITE_STACK_METEOR  $LISTE_BUILD_ARGS -f $CONTEXTE_DOCKER_BUILD_STACK_MARGUERITE_METEOR/Dockerfile $CONTEXTE_DOCKER_BUILD_STACK_MARGUERITE_METEOR
